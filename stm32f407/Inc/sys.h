...
#define PIN15				1<<15 
////////////////////////////////////////////////////////////////////////////////// 
uint8_t Sys_Clock_Set(uint32_t plln,uint32_t pllm,uint32_t pllp,uint32_t pllq);		//ϵͳʱ������
void Stm32_Clock_Init(uint32_t plln,uint32_t pllm,uint32_t pllp,uint32_t pllq); //ʱ�ӳ�ʼ��
...
void Ex_NVIC_Config(uint8_t GPIOx,uint8_t BITx,uint8_t TRIM);				//�ⲿ�ж����ú���(ֻ��GPIOA~I)
void GPIO_AF_Set(GPIO_TypeDef* GPIOx,uint8_t BITx,uint8_t AFx);		//GPIO���ù�������
void GPIO_Set(GPIO_TypeDef* GPIOx,uint32_t BITx,uint32_t MODE,uint32_t OTYPE,uint32_t OSPEED,uint32_t PUPD);//GPIO���ú���
//����Ϊ��ຯ��
